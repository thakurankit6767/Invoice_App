...
const InvoiceCompany = ({ type, setType }) => {
        ...
        <DialogContent>
          <div className={classes.container}>
            <FormControl className={classes.formControl}>
              <InputLabel id="demo-dialog-select-label">Select Company Name</InputLabel>
              <Select
              ...
              >
                ...
                <MenuItem value="Invoice">Abc Transport</MenuItem>
                <MenuItem value="Receipt">Xyz Transport</MenuItem>
              </Select>
            </FormControl>
          </div>
        </DialogContent>
