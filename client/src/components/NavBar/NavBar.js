...
const NavBar = () => {
  ...
  return (
    <div>
      <nav className="navbar" style={{ backgroundColor: "#3498DB " }}>
        <ul className="navbar-nav" >
          <li className="logo" style={{ backgroundColor: "#3498DB " }}>
            <a href="/dashboard" className="nav-link">
              <span className="link-text logo-text" >
                <img
                  style={{ width: "50px" }}
                  src="https://media.istockphoto.com/vectors/shield-secure-safe-with-initial-s-design-inspiration-vector-id1171438815?s=612x612"
                  alt="arc-invoice"
                />
              </span>
              <svg
          ...
          <li className="nav-item">
            <Link to="/dashboard" className="nav-link">
              ...
              <span className="link-text" style={{ color: "white" }}>Dashboard</span>
            </Link>
          </li>
          ...
          <li className="nav-item">
            <a href="/invoice" className="nav-link">
              ...
              <span className="link-text" style={{ color: "white" }}>Create</span>
            </a>
          </li>
          <li className="nav-item">
            <a href="/invoices" className="nav-link">
              ...
              <span className="link-text" style={{ color: "white" }}>Invoices</span>
            </a>
          </li>
          <li className="nav-item">
            <a href="/customers" className="nav-link">
              ...
              <span className="link-text" style={{ color: "white" }}>Customers</span>
            </a>
          </li>
          {/* <li className="nav-item">
        ...
        <span className="link-text">Shuttle</span>
          ...
          <li className="nav-item" id="themeButton">
            <a href="/settings" className="nav-link">
              ...
              <span className="link-text" style={{ color: "white" }}>Settings</span>
            </a>
          </li>
        </ul>
      </nav>
